...
export declare namespace bigqueryreservation_v1beta1 {
    ...
    export class Resource$Projects$Locations$Capacitycommitments {
         ...
         * @return {object} Request object
         */
        upgradeCapacityCommitmentPlan(params?: Params$Resource$Projects$Locations$Capacitycommitments$Upgradecapacitycommitmentplan, options?: MethodOptions): GaxiosPromise<Schema$CapacityCommitment>;
        upgradeCapacityCommitmentPlan(params: Params$Resource$Projects$Locations$Capacitycommitments$Upgradecapacitycommitmentplan, options: MethodOptions | BodyResponseCallback<Schema$CapacityCommitment>, callback: BodyResponseCallback<Schema$CapacityCommitment>): void;
        upgradeCapacityCommitmentPlan(params: Params$Resource$Projects$Locations$Capacitycommitments$Upgradecapacitycommitmentplan, callback: BodyResponseCallback<Schema$CapacityCommitment>): void;
        upgradeCapacityCommitmentPlan(callback: BodyResponseCallback<Schema$CapacityCommitment>): void;
    }
    ...
    export interface Params$Resource$Projects$Locations$Capacitycommitments$Upgradecapacitycommitmentplan extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
