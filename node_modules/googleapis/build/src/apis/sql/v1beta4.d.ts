...
export declare namespace sql_v1beta4 {
    ...
    export class Resource$Projects$Locations$Instances {
         ...
         * @return {object} Request object
         */
        startExternalSync(params?: Params$Resource$Projects$Locations$Instances$Startexternalsync, options?: MethodOptions): GaxiosPromise<Schema$Operation>;
        startExternalSync(params: Params$Resource$Projects$Locations$Instances$Startexternalsync, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback: BodyResponseCallback<Schema$Operation>): void;
        startExternalSync(params: Params$Resource$Projects$Locations$Instances$Startexternalsync, callback: BodyResponseCallback<Schema$Operation>): void;
        startExternalSync(callback: BodyResponseCallback<Schema$Operation>): void;
        /**
         ...
         * @return {object} Request object
         */
        verifyExternalSyncSettings(params?: Params$Resource$Projects$Locations$Instances$Verifyexternalsyncsettings, options?: MethodOptions): GaxiosPromise<Schema$SqlInstancesVerifyExternalSyncSettingsResponse>;
        verifyExternalSyncSettings(params: Params$Resource$Projects$Locations$Instances$Verifyexternalsyncsettings, options: MethodOptions | BodyResponseCallback<Schema$SqlInstancesVerifyExternalSyncSettingsResponse>, callback: BodyResponseCallback<Schema$SqlInstancesVerifyExternalSyncSettingsResponse>): void;
        verifyExternalSyncSettings(params: Params$Resource$Projects$Locations$Instances$Verifyexternalsyncsettings, callback: BodyResponseCallback<Schema$SqlInstancesVerifyExternalSyncSettingsResponse>): void;
        verifyExternalSyncSettings(callback: BodyResponseCallback<Schema$SqlInstancesVerifyExternalSyncSettingsResponse>): void;
    }
    ...
    export interface Params$Resource$Projects$Locations$Instances$Startexternalsync extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    export interface Params$Resource$Projects$Locations$Instances$Verifyexternalsyncsettings extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
